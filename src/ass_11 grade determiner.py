...
You work as a teacher('s assistant and due to her busy schedule she has requested that'
you write a program which will determine the grades of the class')s students.
...
Make sure to run your program multiple times and test it with
values for each 5 of the different grades to make sure that the
correct output is displayed for any value entered as a student's score."""
...
x = int(input("enter stud grades"))

if x >= 90:
    print("student grades A")
else:
    if x >= 80:
        print("student B")
    else:
        if x >= 70:
            ...
            if x >= 60:
                ...
                print("student dropped") # a if can exist without else even if nested
